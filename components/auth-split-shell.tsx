...
export default function AuthSplitShell({ mobileSlot, desktopSlot }: AuthSplitShellProps) {
  ...
  return (
    <main className="min-h-[100lvh] bg-[#03050a] lg:min-h-[100dvh] lg:bg-white">
      <div
        className="grid min-h-[100lvh] lg:min-h-[100dvh] lg:grid-cols-[1.65fr_0.95fr]"
      ...
      >
        ...
        <section className="relative flex min-h-[100lvh] flex-col overflow-x-hidden overflow-y-auto bg-[#03050a] lg:hidden">
          ...
          <div className="relative z-10 flex min-h-[100lvh] flex-col px-6 sm:px-8">
            <div className="flex flex-col items-center gap-3 pt-[max(3.5rem,env(safe-area-inset-top))] sm:pt-[max(4rem,env(safe-area-inset-top))]">
