...
export default function AuthSplitShell({ mobileSlot, desktopSlot }: AuthSplitShellProps) {
  ...
  return (
    <main className="min-h-[100dvh] bg-[#03050a] lg:bg-white">
      <div
      ...
      >
        ...
        <section className="relative flex min-h-[100dvh] flex-col overflow-x-hidden overflow-y-auto bg-[#03050a] lg:hidden">
